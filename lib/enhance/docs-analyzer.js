 ...
 * Main orchestrator for documentation optimization analysis
 *
 * Supports two modes:
 * - 'ai' (--ai): For agent-docs, aggressive RAG optimization
 * - 'both' (default): For user-facing docs, balance readability with AI-friendliness
 *
 * @author Avi Fenesh
 * @license MIT
 */
 ...
 * @param {string} docPath - Path to documentation markdown file
 * @param {Object} options - Analysis options
 * @param {string} options.mode - 'ai' or 'both' (default: 'both')
 * @param {boolean} options.verbose - Include LOW certainty issues
 * @param {string[]} options.existingFiles - List of existing files for link validation
 ...
 * @param {Object} options - Analysis options
 * @param {string} options.doc - Specific doc path (optional)
...
/**
 * Apply documentation-specific fixes
...
/**
 * Fix verbose explanations with concise alternatives
 * @param {string} content - Markdown content
 * @returns {string} Fixed content
 */
